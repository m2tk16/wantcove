...
| P3 High/Low | Optimize generated catalog images | High / Low | Accepted in Beta | All 24 responsive AVIF/WebP variants returned the correct media type and cache policy in Beta and total 765,050 bytes. The app-level SPA rewrite now recognizes AVIF; future replacements should use content-versioned names before extending cache lifetime. |
