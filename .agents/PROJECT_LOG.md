...
- Focused administrator coverage passes 7 tests, including successful reset and complete draft retention after a rejected create. The normal fast gate passes steering, security, CI and hosting invariants, warning-free lint, and all 71 tests.
