...
export function ProductEditor({ product, busy, onCancel, onSave }: {
  ...
  return <form className="product-editor" onSubmit={submit}>
    ...
    <div className="form-grid">
      ...
      <label className="wide-field">Image location<input maxLength={2048} onChange={(event) => update('imageUrl', event.target.value)} placeholder="/products/item.webp or https://…" required value={draft.imageUrl} /></label>
