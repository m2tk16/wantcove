...
import { trackedProductCategories } from '../../catalog/data/categories'
...
export function AdminProductManager({ catalog }: { catalog: AdminProductGateway }) {
  ...
  return <div className="admin-manager">
    <ProductEditor busy={busy} categories={trackedProductCategories(products)} key={editing?.slug ?? 'new-product'} onCancel={() => setEditing(undefined)} onSave={save} product={editing} />
