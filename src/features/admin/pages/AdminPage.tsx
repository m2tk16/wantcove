...
import type { AdminAuthGateway, AdminAuthStep, AdminProductGateway, AdminSession } from '../types'
import '../admin.css'

export function AdminPage({ auth = adminAuthClient, catalog = adminProductClient }: {
